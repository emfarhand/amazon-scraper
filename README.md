...
This project demonstrates a basic web scraping and data processing pipeline using Python. The scraper collects product data for cooking oil from Amazon search results and stores it in a structured CSV format for further analysis.
...
The script will save the raw scraped data as:
...
Simple, maintainable Python project structure
...
Expand to multiple pages or products